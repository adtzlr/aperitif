...
ControlledDOF[nodes[:,0]==0,1] = 'Fixed'
...
df7 = pd.DataFrame(np.array([[10,1,1,2]]),dtype=float)
df7.insert(0, 'Label', ['Rubber'])
df7.insert(1, 'Type', ['multi-k'])
